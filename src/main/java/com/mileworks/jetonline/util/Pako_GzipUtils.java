...
public class Pako_GzipUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String raw = "我来个大操";
        String zipRaw = "%1F%C2%8B%08%00%00%00%00%00%00%03%7B%C3%961%C3%B1%C3%99%C3%9C%C2%A5Ov%C2%ACz%C2%BAd%C3%B9%C2%B3%C3%89%C2%BD%00G%C2%9B%C2%91%C2%8C%0F%00%00%00";
        System.out.println(compress2URI(raw));
        System.out.println(unCompressURI(zipRaw));
